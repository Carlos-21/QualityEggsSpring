$(document).ready(function() {
	...
	$local.$tablaMantenimiento.children("tbody").on("click", ".actualizar", function() {
		...
		$local.idTipoDocumento = persona.sTipoDocumento;
		$local.numeroDocumento = persona.sNumeroDocumento;
	...
	$local.$actualizarMantenimiento.on("click", function() {
		...
		persona.sTipoDocumento = $local.idTipoDocumento;
		persona.sNumeroDocumento = $local.numeroDocumento;
		$.ajax({
			type : "PUT",
			url : $variableUtil.root + "mantenimiento/persona",
	...
	$local.$tablaMantenimiento.children("tbody").on("click", ".eliminar", function() {
		...
		$.confirm({
			...
			title : "Aviso",
			content : "¿Desea eliminar la Persona <b>'" + persona.sTipoDocumento + " - " + persona.sNumeroDocumento + "'<b/>?",
			theme: "bootstrap",
			buttons : {
				Aceptar : {
					action : function() {
							...
							content : function() {
								...
								$.ajax({
									...
									case 400:
										...
										break;
									case 409:
										var mensaje = $funcionUtil.obtenerMensajeError("La Persona <b>" + persona.sTipoDocumento + " - " + persona.sNumeroDocumento + "</b>", xhr.responseJSON, $variableUtil.accionEliminado);

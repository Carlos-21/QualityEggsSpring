...
public class OfertaRestController {
    ...
    public ResponseEntity<?> registrarOferta(@RequestBody Oferta oOferta){
		...
		HiloCorreo oHiloCorreo = new HiloCorreo(oOferta, clienteService.listarClientes(), true);
		oHiloCorreo.start();
    ...
    public ResponseEntity<?> actualizarOferta(@RequestBody Oferta oOferta){
		...
		HiloCorreo oHiloCorreo = new HiloCorreo(oOferta, clienteService.listarClientes(), false);
		oHiloCorreo.start();

...
/**
 * ManProveedorId generated by hbm2java
 */
@Embeddable
public class ManProveedorId implements java.io.Serializable {

	private String manPersonaVNumeroDocumento;
	private String manPersonaVTipoDocumento;

	public ManProveedorId() {
	}

	public ManProveedorId(String manPersonaVNumeroDocumento, String manPersonaVTipoDocumento) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ManProveedorId))
			return false;
		ManProveedorId castOther = (ManProveedorId) other;
